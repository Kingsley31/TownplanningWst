      ...
      <div class="sidebar">
        <div class="user-profile">
          ...
          <div class="info-wrapper">
            ...
            <h6 class="display-income">HEALTH OFFICER</h6>
          </div>
        </div>
        <ul class="navigation-menu">
            <li>
                <a href="{{ route('hodashboard') }}">
            ...
            <li class="nav-category-divider">
                <a href="#hors" data-toggle="collapse" aria-expanded="false">
                  <span class="link-title">HEALTH REPORTS</span>
                  <i class="mdi mdi-flask link-icon"></i>
                </a>
                <ul class="collapse navigation-submenu" id="hors">
                  <li>
                    <a href="{{ route('pendinghors') }}" >PENDING HORS</a>
                  </li>
                  <li>
                    <a href="{{ route('completedhors') }}" >COMPLETED HORS</a>
                  </li>
                </ul>
            </li>
                      ...
                      <div class="col-md-12 equel-grid">
                          <div class="grid">
                              <div class="grid-body py-3">
                                <p class="card-title ml-n1">HORS PENDING UPLOAD</p>
                              </div>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content" style="border: 1px solid #525c5d;">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">Health Report Upload</h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                            <form method="POST" action="{{ route('uploadhor') }}" enctype="multipart/form-data">
                                    @csrf
                            <div class="modal-body">
                                <div class="form-group">
                                    <input type="hidden" name="appid" id="app">
                                    <label for="hor" class="col-form-label">Upload Document:</label>
                                    <input type="file" class="form-control" name="hor" id="hor">
                                </div>
                                <div class="form-group">
