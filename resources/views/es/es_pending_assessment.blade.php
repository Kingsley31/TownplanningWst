              ...
              <div class="col-md-12 equel-grid">
                  <div class="grid">
                      <div class="grid-body py-3">
                        <p class="card-title ml-n1">PENDING ASSESSMENTS</p>
                      </div>
                          ...
                          <tbody>
                            @if (count($applications) > 0)
                                @foreach ($applications as $application)
                                    <tr>
                                        <form method="POST" action="{{ route('esapproveassessment') }}">
                                            @csrf
                                            ...
                                            <td>
                                                <input type="number" class="form-control @error('planningrate') is-invalid @enderror" name="planningrate" value="{{ $application->assessment->planning_rate }}" id="planningrate">
                                            </td>
                                            <td>
                                                <input type="number" class="form-control @error('inspectionrate') is-invalid @enderror" name="inspectionrate" value="{{ $application->assessment->inspection_rate }}" id="inspectionrate">
                                            </td>
                                            <td>
                                                <input type="number" class="form-control @error('registrationfee') is-invalid @enderror" name="registrationfee" value="{{ $application->assessment->registration_fee }}" id="registrationfee">
                                            </td>
                                            <td>
                                                <input type="number" class="form-control @error('chartingfee') is-invalid @enderror" name="chartingfee" value="{{ $application->assessment->charting_fee }}" id="chartingfee">
                                            </td>
                                            <td>
                                                <input type="number" class="form-control @error('fencingfee') is-invalid @enderror" name="fencingfee" value="{{ $application->assessment->fencing_fee }}" id="fencingfee">
                                            </td>
                                            
                                            <td colspan="2">
                                                <input type="number" class="form-control @error('igr') is-invalid @enderror" name="igr" value="{{ $application->assessment->igr_fee }}" id="igr">
                                            </td>
                                            <td>
                                                <input type="number" class="form-control @error('stagepermit') is-invalid @enderror" name="stagepermit" value="{{ $application->assessment->stages_permit_fee }}" id="stagepermit">
                                            </td>
                                            <td>
                                                <input type="number" class="form-control @error('penalty') is-invalid @enderror" name="penalty" value="{{ $application->assessment->penalty_fee }}" id="penalty">
                                            </td>
                                            <td>
                                                <input type="hidden" name="appid" value="{{$application->id}}">
                                                <input type="number" class="form-control @error('total') is-invalid @enderror" name="total" value="{{ $application->assessment->total }}" id="total">
                                            </td>
                                        
                                            <td> <button type="submit" class="btn btn-success">Approve Assessment For Payment</button></td>
                                        </form>
                                    </tr>
                                @endforeach
                            @endif    
