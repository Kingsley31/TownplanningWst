              ...
              <div class="col-md-12 equel-grid">
                  <div class="grid">
                      <div class="grid-body py-3">
                        <p class="card-title ml-n1">SUBMITTED REPORTS</p>
                      </div>
                          ...
                          <tbody>
                            @if (count($applications) > 0)
                                @foreach ($applications as $application)
                                    <tr>
                                        <form method="POST" action="{{ route('esassignchecklist') }}">
                                            @csrf
                                            ...
                                            <td> {{$application->sir}}</td>
                                            <td> {{$application->hor}}</td>
                                            <td> {{$application->cer}}</td>
                                            <td> {{$application->ppi}}</td>  
                                            <td> 
                                                <input type="hidden" name="appid" value="{{$application->id}}">
                                                <button type="submit" class="btn btn-success">Approve For Checklist</button>
                                            </td>       
                                        </form>
                                    </tr>
                                @endforeach
