              ...
              <div class="col-md-12 equel-grid">
                  <div class="grid">
                      <div class="grid-body py-3">
                        <p class="card-title ml-n1">REPORTS PENDING ASSIGNMENT</p>
                      </div>
                          ...
                          <tbody>
                            @if (count($applications) > 0)
                                @foreach ($applications as $application)
                                    <tr>
                                        <form method="POST" action="{{ route('esassignreports') }}">
                                            @csrf
                                            ...
                                            <td>       
                                                <div class="showcase_content_area">
                                                    ...
                                                    <select class="custom-select" name="tposir">
                                                        <option selected value="0">SELECT TPO</option>
                                                        @foreach($tpos as $tpo)
                                                            <option value="{{$tpo->user->id}}">{{$tpo->user->firstname}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <td>       
                                                <div class="showcase_content_area">
                                                    <select class="custom-select" name="hohor">
                                                        <option selected value="0">SELECT HO</option>
                                                        @foreach($hos as $ho)
                                                            <option value="{{$ho->user->id}}">{{$ho->user->firstname}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            @if($application->app_building_height>1)
                                                <td>       
                                                    <div class="showcase_content_area">
                                                        <select class="custom-select" name="engineercer">
                                                            <option selected value="0">SELECT ENGINEER</option>
                                                            @foreach($engs as $eng)
                                                                <option value="{{$eng->user->id}}">{{$eng->user->firstname}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                            ...
                                            <td>       
                                                <div class="showcase_content_area">
                                                    ...
                                                    <select class="custom-select" name="tpoppi">
                                                        <option selected value="0">SELECT TPO</option>
                                                        @foreach($tpos as $tpo)
                                                            <option value="{{$tpo->user->id}}">{{$tpo->user->firstname}}</option>
                                                        @endforeach
