        ...
        <ul class="navigation-menu">
            <li >
                ...
                <i class="mdi mdi-flask link-icon"></i>
                    ...
                    <li>
                        <a href="#checklist" data-toggle="collapse" aria-expanded="false">
                            <span class="link-title">ASSESSMENTS</span>
                            <i class="mdi mdi-flask link-icon"></i>
                        </a>
                        <ul class="collapse navigation-submenu" id="checklist">
                            <li>
                  ...
                  <div class="col-md-12 equel-grid">
                    <div class="grid">
                      <div class="grid-body py-3">
                        <p class="card-title ml-n1">{{("IDPA's")}} AWAITING SIGNATORY</p>
                      </div>
                                ...
                                @foreach ($applications as $application)
                                    <tr>
                                        <form method="POST" action="{{ route('headadminasignslptotpo') }}">
                                            ...
                                            <td><a href="/es/view/idpa/doc/{{$application->id}}">View Document</a></td>
                                            <td>       
                                            ...
                                            <td> <button type="button" class="btn btn-success app-btn" data-toggle="modal" data-target="#signatureModal" data-app_id="{{$application->id}}">Sign Document</button></td>
                                        </form>
                                    </tr>
                                @endforeach
                            @endif  
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content" style="border: 1px solid #525c5d;">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Signature Authentication</h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <form method="POST" action="{{ route('signidpadoc') }}" enctype="multipart/form-data">
                                @csrf
                        <div class="modal-body">
                            <div class="form-group">
                              <input type="hidden" name="appid" id="app">
                              <label for="message-text" class="col-form-label">Signature Password</label>
                              <input type="password" name="signature-password" class="form-control" id="password"/>
                            </div>
