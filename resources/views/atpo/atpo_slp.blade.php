      ...
      <div class="sidebar">
        <div class="user-profile">
          <div class="display-avatar animated-avatar">
            <img class="profile-img img-lg rounded-circle" src="../assets/images/profile/male/image_1.jpg" alt="profile image">
          </div>
          <div class="info-wrapper">
            <p class="user-name">{{$user->lastname}} {{$user->firstname}}</p>
            <h6 class="display-income">ATPO</h6>
          </div>
        </div>
        <ul class="navigation-menu">
            <li>
                <a href="{{ route('atpodashboard') }}">
                        ...
                        <table class="table table-hover table-sm ">
                          <thead>
                            <tr class="solid-header">
                                ...
                                <th>UPLOAD SITE LOCATION PLAN</th>
                            </tr>
                          </thead>
                          <tbody>
                              @if (count($applications) > 0)
                                @foreach ($applications as $application)
                                    <tr>
                                        <form method="POST" action="{{ route('atpouploadslp') }}" enctype="multipart/form-data">
                                                  @csrf
                                                  ...
                                                  <td>       
                                                      <div class="showcase_content_area">
                                                          ...
                                                          <input type="file" class="form-control" name="siteplan" id="siteplan">
                                                      </div>
                                                  
                                                  </td>
                                                  <td> <button type="submit" name="submit" class="btn btn-success">Upload</button></td>
                                              </form>
                                          </tr>
                                      @endforeach
                                  @endif  
