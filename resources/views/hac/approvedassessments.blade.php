      ...
      <div class="sidebar">
        <div class="user-profile">
          ...
          <div class="info-wrapper">
            ...
            <h6 class="display-income">HEAD OF ACCOUNT</h6>
          </div>
        </div>
        <ul class="navigation-menu">
            <li>
                <a href="{{ route('hacdashboard') }}">
            ...
            <li class="nav-category-divider">
                <a href="{{ route('hacapprovedassesments') }}">
                  <span class="link-title">APPROVED ASSESSMENTS</span>
                  <i class="mdi mdi-flask link-icon"></i>
                </a>
              ...
              <div class="col-md-12 equel-grid">
                  <div class="grid">
                      <div class="grid-body py-3">
                        <p class="card-title ml-n1">APPROVED ASSESSMENTS</p>
                      </div>
                          ...
                          <tbody>
                                  ...
                                  @if (count($applications) > 0)
                                    @foreach ($applications as $application)
                                        <tr>
                                            <form method="POST" action="{{ route('assignaccountofficerpayment') }}">
                                                @csrf
                                                ...
                                                <td>       
                                                    <div class="showcase_content_area">
                                                        ...
                                                        <select class="custom-select" name="aco">
                                                            <option selected value="0">Select Account Officer</option>
                                                            @foreach($acos as $aco)
                                                                <option value="{{$aco->user->id}}">{{$aco->user->firstname}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
