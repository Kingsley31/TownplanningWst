                                        ...
                                        <form method="POST" action="{{ route('tpoasignslptoatpo') }}">
                                            ...
                                            <td>       
                                                <div class="showcase_content_area">
                                                    ...
                                                    <select class="custom-select" name="atpo">
                                                        <option selected value="0">SELECT ATPO</option>
                                                        @foreach($atpos as $atpo)
                                                            <option value="{{$atpo->user->id}}">{{$atpo->user->firstname}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
