                      ...
                      <div class="col-md-12 equel-grid">
                          <div class="grid">
                              <div class="grid-body py-3">
                                <p class="card-title ml-n1">PPI'S PENDING UPLOAD</p>
                              </div>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content" style="border: 1px solid #525c5d;">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">PPI Upload</h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                            <form method="POST" action="{{ route('uploadppi') }}" enctype="multipart/form-data">
                                    @csrf
                            <div class="modal-body">
                                <div class="form-group">
                                    <input type="hidden" name="appid" id="app">
                                    <label for="ppi" class="col-form-label">Upload Document:</label>
                                    <input type="file" class="form-control" name="ppi" id="ppi">
                                </div>
                                <div class="form-group">
