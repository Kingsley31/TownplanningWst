                  ...
                  <div class="col-md-12 equel-grid">
                    <div class="grid">
                      <div class="grid-body py-3">
                        <p class="card-title ml-n1">{{("CHECKLIST's")}} AWAITING APPROVAL</p>
                      </div>
                        ...
                        <table class="table table-hover table-sm ">
                          <thead>
                            <tr class="solid-header">
                              ...
                              <th>View Application Documents</th> 
                            </tr>
                          </thead>
                          <tbody>
                                ...
                                @foreach ($applications as $application)
                                    <tr>
                                        <form method="POST" action="{{ route('approvechecklist') }}">
                                            ...
                                            <td> <a href="/app/documents/{{$application->id}}">View documents</a></td>
                                            <td> 
                                                <input type="hidden" name="appid" value="{{$application->id}}">
                                                <button type="submit" class="btn btn-success">Approve For IDPA Signing</button>
                                            </td>
                                        </form>
                                    </tr>
                                @endforeach
